...
<body>
	<div class="side-features" aria-hidden="false">
		<a href="pages/forecast.php" class="feature-small" title="Prakiraan Cuaca">
			<div class="icon">📊</div>
			<div>Prakiraan</div>
		</a>
		<a href="pages/map.php" class="feature-small" title="Peta Kota">
			<div class="icon">🗺️</div>
			<div>Peta Kota</div>
		</a>
		<a href="pages/geography.php" class="feature-small" title="Geography">
			<div class="icon">🌍</div>
			<div>Geography</div>
		</a>
	</div>
