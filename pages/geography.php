    ...
    <div class="container">
        <div class="placeholder">
            ...
            <ul style="text-align: left; display: inline-block;">
                <li>Data cuaca berdasarkan wilayah geografis</li>
                <li>Informasi iklim regional</li>
                <li>Perbandingan cuaca antar wilayah</li>
                <li>Statistik cuaca berdasarkan geografi</li>
            </ul>
